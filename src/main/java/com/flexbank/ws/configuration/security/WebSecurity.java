...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                ...
                .permitAll()
                .antMatchers(SecurityConstants.RESET_PASSWORD_VERIFY_PHONE_NUMBER_URL)
                .permitAll()
                .antMatchers(SecurityConstants.RESET_PASSWORD_SMS_CODE_URL)
                .permitAll()
                .and()
                ...
                .addFilterBefore(new SignupFilter(customerPhoneNumberService),
                        AuthenticationFilter.class)
                .authorizeRequests()
                .antMatchers(SecurityConstants.RESET_PASSWORD_URL)
                .permitAll().and()
                .addFilterBefore(new ResetPasswordFilter(customerPhoneNumberService),
                        AuthenticationFilter.class)
                .authorizeRequests()
